...
tf.app.flags.DEFINE_integer('batch_size', 2, 'dataPath')
tf.app.flags.DEFINE_integer('prefetch_size', 1024, 'dataPath')
FLAGS = tf.app.flags.FLAGS
...
est.train(input_fn=lambda: input_fn(FLAGS.train_data_path), steps=100)
eval_result = est.evaluate(input_fn=lambda: input_fn(FLAGS.test_data_path))
